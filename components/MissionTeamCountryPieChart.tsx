    ...
    <div className="overflow-x-auto" style={{ minWidth: '800px' }}>
      <table className="w-full border border-gray-300 rounded-xl" style={{ minWidth: '800px' }}>
        <thead className="bg-gray-100">
          <tr>
            <th className="p-3 text-left" style={{ minWidth: '80px' }}>연도</th>
            <th className="p-3 text-left" style={{ minWidth: '150px' }}>국가</th>
            <th className="p-3 text-right" style={{ minWidth: '100px' }}>인원 수</th>
            <th className="p-3 text-right" style={{ minWidth: '120px' }}>기간 시작</th>
            <th className="p-3 text-right" style={{ minWidth: '120px' }}>기간 종료</th>
          ...
          {data.length === 0 ? (
            ...
            data.map((item, idx) => (
              <tr key={idx} className="border-t">
                ...
                <td className="p-3 text-right">{item.period_start}</td>
                <td className="p-3 text-right">{item.period_end}</td>
